...
# Rows: 30,463 and # Columns: 15


**2. What are the data types of the variables in this dataset?**
Double, Character and date are the data types in this dataset.
...
ggplot(data = surveys, 
  ...
  labs(title = "Relationship of Weight vs Hindfoot Length in species", 
       subtitle = "evaluating how different species weight and hindfoot length relate to one another",
       x = "Weight (g)", 
...
ggplot(data = surveys, aes(x = species_id,
                           y = weight)) +  
  geom_boxplot(outlier.shape = NA) +  
  geom_jitter(color = "springgreen4",
              alpha = 0.5) +  
  labs(title = "Range of Weight in Various Species",
       x = "Species ID",
       y = "Weight (grams)") +  
...
ggplot(data = surveys, aes(y = species_id,
                           x = weight)) +  
  geom_boxplot(outlier.shape = NA) +  
  geom_jitter(color = "springgreen4",
              alpha = 0.2) +  
